...
var g_worker_pagmode_outlook = null;
...
function enable_outlook_conversation(  )//bool
{
	...
	if(!!enable)
	{
		...
		if(g_worker_pagmode_outlook)
		{
			g_worker_pagmode_outlook.port.emit(c_msg_name_status_outlook_action, c_msg_val_status_outlook_action_start);
		}
	}
	else
	{
		if(g_pagmode_outlook)
		{
			if(g_worker_pagmode_outlook)
			{
				g_worker_pagmode_outlook.port.emit(c_msg_name_status_outlook_action, c_msg_val_status_outlook_action_stop);
			}
